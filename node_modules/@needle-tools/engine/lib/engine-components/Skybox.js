...
import { EquirectangularRefractionMapping, SRGBColorSpace, TextureLoader } from "three";
...
ContextRegistry.addContextCreatedCallback((args) => {
    ...
    if (skyboxImage) {
        ...
        if (context.mainCameraComponent?.clearFlags !== ClearFlags.Skybox)
            console.warn("\"skybox-image\" attribute has no effect: camera clearflags are not set to \"Skybox\"");
...
export class RemoteSkybox extends Behaviour {
    ...
    validTextureTypes = [".hdr", ".exr", ".jpg", ".jpeg", ".png"];
    isRemoteTexture(url) {
