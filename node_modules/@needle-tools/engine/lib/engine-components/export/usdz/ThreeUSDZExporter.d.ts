...
import { AnimationClip, BufferGeometry, Material, Matrix4, MeshBasicMaterial, MeshStandardMaterial, Object3D, OrthographicCamera, PerspectiveCamera, SkinnedMesh, Texture, Vector4, WebGLRenderer } from 'three';
...
declare class USDObject {
    ...
    constructor(id: any, name: any, matrix: any, mesh?: BufferGeometry | null, material?: MeshStandardMaterial | MeshBasicMaterial | Material | null, camera?: PerspectiveCamera | OrthographicCamera | null, skinnedMesh?: SkinnedMesh | null, animations?: AnimationClip[] | null);
    is(obj: any): boolean;
    isEmpty(): boolean;
    clone(): USDObject;
    deepClone(): USDObject;
