...
import { EmphasizeActionMotionType } from "./BehavioursBuilder.js";
...
export declare class PlayAnimationOnClick extends Behaviour implements IPointerClickHandler, UsdzBehaviour, UsdzAnimation {
    ...
    afterSerialize(): void;
    afterCreateDocument(ext: BehaviorExtension, context: USDZExporterContext): void;
    static getActionForSequences(model: USDObject, animationSequence?: Array<RegisteredAnimationInfo>, animationLoopAfterSequence?: Array<RegisteredAnimationInfo>): import("./BehavioursBuilder.js").GroupActionModel;
