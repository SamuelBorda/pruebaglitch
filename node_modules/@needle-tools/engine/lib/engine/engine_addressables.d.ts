...
export declare class AssetReference {
    ...
    instantiate(parent?: Object3D | IInstantiateOptions): Promise<IGameObject | null>;
    /** loads and returns a new instance of `asset` - this call is networked so an instance will be created on all connected users */
    instantiateSynced(parent?: Object3D | SyncInstantiateOptions, saveOnServer?: boolean): Promise<IGameObject | null>;
