...
export class RapierPhysics {
    ...
    addForce(rigidbody, force, wakeup) {
        ...
        if (body)
            ...
            console.warn("Rigidbody doesn't exist: can not apply force");
    }
    addImpulse(rigidbody, force, wakeup) {
        ...
        if (body)
            ...
            console.warn("Rigidbody doesn't exist: can not apply impulse");
    }
    ...
    wakeup(rb) {
        ...
        if (body)
            ...
            console.warn("Rigidbody doesn't exist: can not wake up");
    }
    isSleeping(rb) {
        this.validate();
        const body = this.internal_getRigidbody(rb);
    ...
    setAngularVelocity(rb, vec, wakeup) {
        ...
        if (body)
            ...
            console.warn("Rigidbody doesn't exist: can not set angular velocity");
    }
    setLinearVelocity(rb, vec, wakeup) {
        ...
        if (body)
            ...
            console.warn("Rigidbody doesn't exist: can not set linear velocity");
    }
    context;
    _initializePromise;
