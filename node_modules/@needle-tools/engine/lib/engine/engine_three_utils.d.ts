import { Box3, Color, Euler, Material, Mesh, Object3D, Quaternion, Texture, Vector3 } from "three";
 ...
 * ```
 */
export declare function getTempVector(vecOrX?: Vector3 | number | DOMPointReadOnly, y?: number, z?: number): Vector3;
 ...
 */
export declare function getBoundingBox(objects: Object3D[], ignore?: ((obj: Object3D) => void | boolean) | Array<Object3D | null | undefined> | undefined): Box3;
/**
