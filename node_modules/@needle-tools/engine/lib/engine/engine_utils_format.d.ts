 ...
 */
export declare function tryDetermineFileTypeFromURL(url: string, lazy?: boolean): Promise<FileType>;
/** Attempts to determine the file type of a binary file by looking at the first few bytes of the file.
 * @hidden
 */
export declare function tryDetermineFileTypeFromBinary(data: ArrayBuffer): FileType;
